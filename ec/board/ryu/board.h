...
/*
 * Allow dangerous commands all the time.
 */
...
#define CONFIG_BATTERY_CRITICAL_SHUTDOWN_TIMEOUT 120
...
#define CONFIG_POWER_BOOT_ON_AC
#define CONFIG_POWER_BUTTON
#define CONFIG_POWER_BUTTON_ACTIVE_STATE 1
#define CONFIG_POWER_IGNORE_LID_OPEN

#undef  BATTERY_LEVEL_SHUTDOWN
#define BATTERY_LEVEL_SHUTDOWN            1
